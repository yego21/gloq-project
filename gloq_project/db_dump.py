...
# Get all models (excluding system models)
all_models = []
excluded_models = []
...
for model in apps.get_models():
    ...
    if model_label in EXCLUDE_MODELS:
        excluded_models.append(model_label)
    else:
        all_models.append(model)

print(f"🗂️  Found {len(all_models)} models (excluding {len(excluded_models)} system models):")
for model in all_models:
    print(f"  - {model._meta.app_label}.{model._meta.model_name}")

if excluded_models:
    print()
    print("🚫 Excluded system models:")
    for model_label in excluded_models:
        print(f"  - {model_label}")
